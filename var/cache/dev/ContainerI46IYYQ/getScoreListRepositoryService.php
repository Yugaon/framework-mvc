 ...
 */
class getScoreListRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ScoreListRepository' shared autowired service.
     *
     * @return \App\Repository\ScoreListRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ScoreListRepository.php';

        return $container->privates['App\\Repository\\ScoreListRepository'] = new \App\Repository\ScoreListRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
